...
trait Bridgeable
{
    protected static function proxy(?string $destination = null, ?string $method = null): ProxyInterface
    {
        return self::bridge($destination, $method)->proxy();
    }

    protected static function bridge(?string $destination = null, ?string $method = null): BridgeInterface
    {
