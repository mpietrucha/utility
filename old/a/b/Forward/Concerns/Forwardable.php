...
use Mpietrucha\Utility\Forward\Concerns\Contracts\ForwardInterface;
use Mpietrucha\Utility\Forward\Contracts\ProxyInterface;

trait Forwardable
{
    public function proxy(null|object|string $destination = null, ?string $method = null): ProxyInterface
    {
